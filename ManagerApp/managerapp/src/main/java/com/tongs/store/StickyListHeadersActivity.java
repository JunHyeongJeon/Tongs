...
import com.tongs.store.adapter.MyStickyListHeadersAdapter;
...
public class StickyListHeadersActivity extends ActionBarActivity {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		setContentView(com.tongs.store.R.layout.activity_stickylistheaders);

		StickyListHeadersListView listView = (StickyListHeadersListView) findViewById(com.tongs.store.R.id.activity_stickylistheaders_listview);
