...
public class SignUpActivityForth extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tongs.store.R.layout.activity_sign_up_activity_forth);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        authToken = mPref.getString("emailToken", null);


        Button mBackButton = (Button)findViewById(com.tongs.store.R.id.sign_up_forth_back_button);
        ...
        Button mNextButton = (Button)findViewById(com.tongs.store.R.id.sign_up_forth_next_button);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.tongs.store.R.menu.menu_sign_up_activity_forth, menu);
        return true;
    }
    ...
    private void sendGCMKey()
    {
        ...
        String url = getText(com.tongs.store.R.string.Server_URL)
                + "store/auth/gcm?"
                + "token=" + authToken
                + "&gcm=" + regid;
