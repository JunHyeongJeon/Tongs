...
import com.tongs.store.view.AlphaForegroundColorSpan;
...
public class ParallaxKenBurnsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mHeaderHeight = getResources().getDimensionPixelSize(
				com.tongs.store.R.dimen.ken_burns_header);
		mMinHeaderTranslation = -mHeaderHeight + getActionBarHeight();
		setContentView(com.tongs.store.R.layout.activity_parallax_ken_burns);
		mListView = (ListView) findViewById(com.tongs.store.R.id.list_view);
		mHeader = findViewById(com.tongs.store.R.id.header);
		mHeaderPicture = (KenBurnsView) findViewById(com.tongs.store.R.id.header_picture);
		
		mHeaderPicture.setImageResource(com.tongs.store.R.drawable.splash_screen_background);
		
		mHeaderPicture.setScaleType(ScaleType.CENTER_CROP);
		mHeaderLogo = (ImageView) findViewById(com.tongs.store.R.id.header_logo);
		mActionBarTitleColor = Color.WHITE;
		mSpannableString = new SpannableString(
				getString(com.tongs.store.R.string.app_name));
	...
	private void setupListView() {
		mPlaceHolderView = getLayoutInflater().inflate(
				com.tongs.store.R.layout.header_fake, mListView, false);
	...
	private void setupActionBar() {
		...
		actionBar.setIcon(com.tongs.store.R.drawable.ic_transparent);
	}
