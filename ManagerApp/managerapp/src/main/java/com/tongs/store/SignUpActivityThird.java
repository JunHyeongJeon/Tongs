...
public class SignUpActivityThird extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tongs.store.R.layout.activity_sign_up_activity_third);


        // Set up the login form.
        mPhoneNumber = (EditText) findViewById(com.tongs.store.R.id.phone_number);
        ...
        mSendButton = (Button)findViewById(com.tongs.store.R.id.send_button);
    ...
    public void Send(){
        EditText phoneNumberEditText = (EditText)findViewById(com.tongs.store.R.id.phone_number);
        ...
        if(phoneNumber != null && isValidCellPhoneNumber(phoneNumber)){
            ...
            String url = getText(com.tongs.store.R.string.sign_up_sms_check_url) + phoneNumber;
        ...
        protected void onPostExecute(String result)
        {
            ...
            try {
                ...
                if("yeah".equals(result_msg)){
                    ...
                    dialog.dismiss();
                    mSendButton.setText(com.tongs.store.R.string.button_certification_success);
                    Toast toast = Toast.makeText(getApplicationContext(),
    ...
    private void ChangeToEnterNumber(){
        ...
        mPhoneNumber.setHint(com.tongs.store.R.string.enter_certification_number);
        mSendButton.setText(com.tongs.store.R.string.button_certification);
    ...
    private void Check(){
        ...
        */
        ...
        if(!"".equals(mPhoneNumber.getText())){
            String url = getText(com.tongs.store.R.string.sign_up_sms_check) + emailToken +
