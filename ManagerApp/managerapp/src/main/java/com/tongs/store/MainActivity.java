...
import com.tongs.store.fragment.CheckAndRadioBoxesFragment;
import com.tongs.store.fragment.ImageGalleryFragment;
import com.tongs.store.fragment.LeftMenusFragment;
import com.tongs.store.fragment.ListViewsFragment;
import com.tongs.store.fragment.LogInPageFragment;
import com.tongs.store.fragment.ParallaxEffectsFragment;
import com.tongs.store.fragment.ProgressBarsFragment;
import com.tongs.store.fragment.SearchBarsFragment;
import com.tongs.store.fragment.ShapeImageViewsFragment;
import com.tongs.store.fragment.SplashScreensFragment;
import com.tongs.store.fragment.TextViewsFragment;
...
/*
	...
	private void prepareNavigationDrawerItems() {
		...
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_list_views,
						com.tongs.store.R.string.drawer_title_list_views,
						DrawerItem.DRAWER_ITEM_TAG_LIST_VIEWS));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_parallax,
						com.tongs.store.R.string.drawer_title_parallax,
						DrawerItem.DRAWER_ITEM_TAG_PARALLAX));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_left_menus,
						com.tongs.store.R.string.drawer_title_left_menus,
						DrawerItem.DRAWER_ITEM_TAG_LEFT_MENUS));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_login_page,
						com.tongs.store.R.string.drawer_title_login_page,
						DrawerItem.DRAWER_ITEM_TAG_LOGIN_PAGE_AND_LOADERS));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_image_gallery,
						com.tongs.store.R.string.drawer_title_image_gallery,
						DrawerItem.DRAWER_ITEM_TAG_IMAGE_GALLERY));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_shape_image_views,
						com.tongs.store.R.string.drawer_title_shape_image_views,
						DrawerItem.DRAWER_ITEM_TAG_SHAPE_IMAGE_VIEWS));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_progress_bars,
						com.tongs.store.R.string.drawer_title_progress_bars,
						DrawerItem.DRAWER_ITEM_TAG_PROGRESS_BARS));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_check_and_radio_buttons,
						com.tongs.store.R.string.drawer_title_check_and_radio_buttons,
						DrawerItem.DRAWER_ITEM_TAG_CHECK_AND_RADIO_BOXES));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_splash_screens,
						com.tongs.store.R.string.drawer_title_splash_screens,
						DrawerItem.DRAWER_ITEM_TAG_SPLASH_SCREENS));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_search_bars,
						com.tongs.store.R.string.drawer_title_search_bars,
						DrawerItem.DRAWER_ITEM_TAG_SEARCH_BARS));
		mDrawerItems.add(
				new DrawerItem(
						com.tongs.store.R.string.drawer_icon_text_views,
						com.tongs.store.R.string.drawer_title_text_views,
	...
	private class CommitFragmentRunnable implements Runnable {
		...
		public void run() {
			...
			fragmentManager.beginTransaction()
					.replace(com.tongs.store.R.id.content_frame, fragment)
					.commit();
		}
	}
