...
import com.tongs.user.view.KenBurnsView;


public class SplashScreensActivity extends Activity	{

	public static final String SPLASH_SCREEN_OPTION = "com.tongs.user.tongs.SplashScreensActivity";
...
//		Preference.getInstance().init(this.getApplicationContext());
		...
		mSplashText = (ImageView) findViewById(R.id.splash_image_text);
		mSplashText.setImageResource(R.drawable.splash_screen_logo_text);
		...
		Handler handler = new Handler() {
			public void handleMessage(Message msg) {
				if( !isClickStatus ){
					...
					startActivity(new Intent(SplashScreensActivity.this, IntroActivity.class));
					finish();
				}
			}
		};
