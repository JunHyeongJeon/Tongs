...
import com.example.user.adapter.DrawerAdapter;
import com.example.user.tab.SlidingTabLayout;
import com.example.user.adapter.ViewPagerAdapter;
import com.example.user.tab.StoreTab;
import com.example.user.tab.TicketTab;
