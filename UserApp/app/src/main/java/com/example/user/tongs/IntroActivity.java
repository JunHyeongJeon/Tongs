package com.example.user.tongs;
        ...
        IHttpRecvCallback cb = new IHttpRecvCallback() {
            public void onRecv(String result) {
                try {
                    ...
                    String versionCode = json.getJSONObject("app").getString("versionCode");
                    String forceUpdate = json.getJSONObject("app").getString("force_update");


                    SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                    SharedPreferences.Editor editor = mPref.edit();
                    editor.putString("versionCode", versionCode);
                    editor.putString("forceUpdate", forceUpdate);
                    editor.commit();
