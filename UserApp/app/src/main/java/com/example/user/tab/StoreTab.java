...
import com.example.user.ble.BleManager;
import com.example.user.adapter.StoreAdapter;
import com.example.user.tongs.BarcodeGenerator;
import com.example.jaecheol.tongs.R;
import com.example.user.tongs.StoreViewActivity;
